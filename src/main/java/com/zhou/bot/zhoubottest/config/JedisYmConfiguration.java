 ...
 * @Description // EnableCaching 必须加，使配置生效
 * @Author ZhouYouMing
 * @Date 2019/2/16 22:14
 */
@Configuration
@EnableCaching
public class JedisYmConfiguration extends CachingConfigurerSupport {

    private static Logger log = LoggerFactory.getLogger(JedisYmConfiguration.class);
    ...
    @Value("${spring.redis.defredisdb}")
    private int defredisdb;
    ...
    public JedisConnectionFactory redisConnectionFactory(JedisPoolConfig jedisPoolConfig) {
        ...
        redisStandaloneConfiguration.setDatabase(defredisdb);
        //获得默认的连接池构造
    ...
    public RedisTemplate<String, Object> redisTemplate(JedisConnectionFactory jedisConnectionFactory) {
        //设置序列化:参考：https://blog.csdn.net/ruby_one/article/details/79141940
